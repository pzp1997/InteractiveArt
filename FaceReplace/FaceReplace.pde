...
String paintingFilename = "IMG_0985.JPG";
...
void draw() {
  ...
  if (liveFace.width > 0 && liveFace.height > 0) {
    ...
    copy(maskedFace, 0, 0, maskedFace.width, maskedFace.height,
          paintingFace.x, paintingFace.y, paintingFace.width, paintingFace.height );
  }
}
